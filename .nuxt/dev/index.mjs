...
import { renderToString } from 'file://C:/Users/Ange/Documents/Dev/souplesse-speckit/node_modules/vue/server-renderer/index.mjs';
import { klona } from 'file://C:/Users/Ange/Documents/Dev/souplesse-speckit/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/Ange/Documents/Dev/souplesse-speckit/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://C:/Users/Ange/Documents/Dev/souplesse-speckit/node_modules/scule/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://C:/Users/Ange/Documents/Dev/souplesse-speckit/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://C:/Users/Ange/Documents/Dev/souplesse-speckit/node_modules/devalue/index.js';
import { isVNode, isRef, toValue } from 'file://C:/Users/Ange/Documents/Dev/souplesse-speckit/node_modules/vue/index.mjs';
import { createHooks } from 'file://C:/Users/Ange/Documents/Dev/souplesse-speckit/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://C:/Users/Ange/Documents/Dev/souplesse-speckit/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://C:/Users/Ange/Documents/Dev/souplesse-speckit/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/Ange/Documents/Dev/souplesse-speckit/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/Ange/Documents/Dev/souplesse-speckit/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file://C:/Users/Ange/Documents/Dev/souplesse-speckit/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/Ange/Documents/Dev/souplesse-speckit/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://C:/Users/Ange/Documents/Dev/souplesse-speckit/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://C:/Users/Ange/Documents/Dev/souplesse-speckit/node_modules/youch-core/build/index.js';
import { Youch } from 'file://C:/Users/Ange/Documents/Dev/souplesse-speckit/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://C:/Users/Ange/Documents/Dev/souplesse-speckit/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://C:/Users/Ange/Documents/Dev/souplesse-speckit/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://C:/Users/Ange/Documents/Dev/souplesse-speckit/node_modules/errx/dist/index.js';
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/Users/Ange/Documents/Dev/souplesse-speckit","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/Users/Ange/Documents/Dev/souplesse-speckit/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/Users/Ange/Documents/Dev/souplesse-speckit/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/Users/Ange/Documents/Dev/souplesse-speckit/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:/Users/Ange/Documents/Dev/souplesse-speckit/.data/kv"}));
...
const _CQWr083Tr5yHwrUoYUvfLMJyw_mpY4eDY5wFBGXFTo = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "C:/Users/Ange/Documents/Dev/souplesse-speckit";
...
const _8WzbEV1KozPSSZkKQ25UIqO_d59n23VGYvywNxw5DeM = (nitroApp) => {
...
const plugins = [
  _CQWr083Tr5yHwrUoYUvfLMJyw_mpY4eDY5wFBGXFTo,
_8WzbEV1KozPSSZkKQ25UIqO_d59n23VGYvywNxw5DeM
];
...
const _H5yKyj = eventHandler((event) => {
...
const getServerEntry = () => import('file://C:/Users/Ange/Documents/Dev/souplesse-speckit/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
// @ts-expect-error file will be produced after app build
const getClientManifest = () => import('file://C:/Users/Ange/Documents/Dev/souplesse-speckit/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
// -- SSR Renderer --
...
const handlers = [
  ...
  { route: '/**', handler: _lazy_X7k_pb, lazy: true, middleware: false, method: undefined }
];
...
async function updateGymSettings(data) {
...
async function upsertBusinessHours(entries) {
...
const settings_put = defineEventHandler(async (event) => {
  ...
  for (const key of Object.keys(map)) {
    const days = map[key];
    const period = openingHours[key];
    for (const d of days) {
      entries.push({ dayOfWeek: d, openTime: period.open, closeTime: period.close, isHolidayOverride: false });
    }
  }
...
async function createPaymentOrder(opts) {
  ...
  if (KKIAPAY_SECRET_KEY) {
    ...
    const token = ((_a = body.data) == null ? void 0 : _a.token) || body.token || null;
...
async function verifyWebhookSignature(rawBody, signatureHeader) {
  ...
  const computed = crypto$1.createHmac("sha256", secret).update(rawBody).digest("hex");
  try {
    return crypto$1.timingSafeEqual(Buffer.from(computed), Buffer.from(signatureHeader));
  } catch (e) {
    return false;
  }
}
async function handleWebhook(envelope, rawPayload) {
  var _a, _b, _c;
  const event = envelope.event;
  const data = envelope.data;
  const paymentId = data.id || data.paymentId || data.payment_id;
  const reference = data.reference || ((_a = data.metadata) == null ? void 0 : _a.reference) || ((_b = data.metadata) == null ? void 0 : _b.orderReference) || ((_c = data.meta) == null ? void 0 : _c.reference);
...
const kkiapay_createOrder = defineEventHandler(async (event) => {
  ...
  try {
    const result = await createPaymentOrder({ userId: user.id, subscriptionPlanId: parse.data.subscriptionPlanId });
...
const kkiapay_createOrder$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: kkiapay_createOrder
}, Symbol.toStringTag, { value: 'Module' }));
...
const subscriptionPlans_get$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: subscriptionPlans_get
}, Symbol.toStringTag, { value: 'Module' }));
