      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center justify-between gap-4">
        ...
        <nav class="hidden lg:flex items-center gap-0.5 flex-1 justify-center">
          ...
          <template v-if="isClient">
            <div v-if="hasActiveSub" class="relative" @mouseenter="sessionsDrop = true" @mouseleave="sessionsDrop = false">
              ...
              <Transition name="drop">
                <div v-if="sessionsDrop" class="dropdown-panel">
                  ...
                  <NuxtLink to="/programs" class="dropdown-item" @click="sessionsDrop = false">
            ...
            <div v-if="hasActiveSub" class="relative" @mouseenter="bookingsDrop = true" @mouseleave="bookingsDrop = false">
              ...
              <Transition name="drop">
                <div v-if="bookingsDrop" class="dropdown-panel">
                  <NuxtLink to="/reservations" class="dropdown-item" @click="bookingsDrop = false">
                  ...
                  <NuxtLink to="/calendar" class="dropdown-item" @click="bookingsDrop = false">
                    <svg class="w-4 h-4 text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                    Calendrier
                  </NuxtLink>
                </div>
            ...
            <NuxtLink to="/subscriptions" class="nav-pill" active-class="nav-pill-active">
            ...
            <div v-if="drawerOpen" class="absolute inset-y-0 left-0 w-72 sm:w-80 bg-gray-950 flex flex-col shadow-2xl">
              ...
              <nav class="flex-1 overflow-y-auto px-3 py-3 space-y-1">
                ...
                <div v-if="isClient">
                  ...
                  <NuxtLink to="/subscriptions" class="drawer-link" active-class="drawer-link-active" @click="drawerOpen = false">
      ...
      >
        <div class="flex items-stretch h-14">
          ...
          <template v-if="isClient">
            ...
            <NuxtLink to="/subscriptions" class="bottom-nav-item" active-class="bottom-nav-item-active">
...
<script setup lang="ts">
  ...
  const isOnBookingsRoute = computed(() => route.path.startsWith('/reservations') || route.path.startsWith('/calendar'))
  const isOnSessionsRoute = computed(() => route.path === '/sessions' || route.path.startsWith('/programs'))
