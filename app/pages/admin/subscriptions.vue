  ...
  <div>
    ...
    <div class="flex items-center justify-between mb-8">
      <div>
        ...
        <p class="text-sm text-gray-500 mt-0.5">GÃ©rez et contrÃ´lez les abonnements clients.</p>
      </div>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
      ...
      <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 flex flex-col gap-1">
        <p class="text-xs font-semibold text-gray-500 uppercase tracking-wide">ExpirÃ©s</p>
        <p class="text-3xl font-extrabold text-gray-400">{{ countByStatus('EXPIRED') }}</p>
      </div>
      <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 flex flex-col gap-1">
        <p class="text-xs font-semibold text-gray-500 uppercase tracking-wide">AnnulÃ©s</p>
      ...
      <table class="w-full text-sm">
        <thead class="bg-gray-50 border-b border-gray-100">
          <tr>
            ...
            <th class="px-4 py-3 text-left font-medium text-gray-600">DÃ©but</th>
        ...
        <tbody class="divide-y divide-gray-50">
          ...
          >
            <td class="px-4 py-3">
              <p class="font-medium text-gray-900">{{ sub.user?.name ?? 'â€”' }}</p>
            ...
            <td class="px-4 py-3 text-right flex justify-end gap-2">
              ...
              >
                {{ toggling === sub.id ? 'â€¦' : 'RÃ©activer' }}
              </button>
              <span v-else-if="sub.status === 'PENDING'" class="text-xs text-gray-300">â€”</span>
            </td>
          </tr>
        ...
        <div v-if="showGrant" class="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
          <div class="bg-white rounded-2xl shadow-xl p-6 w-full max-w-md">
            ...
            <p class="text-xs text-gray-400 mb-5">
              {{ grantMode === 'extend' ? 'Ajoute la durÃ©e du plan Ã  l\'abonnement actuel.' : 'CrÃ©e et active immÃ©diatement un abonnement sans paiement.' }}
            </p>
            ...
            <div class="space-y-4">
              ...
              <div>
                ...
                <select v-model="grantForm.userId" class="input w-full" :disabled="grantMode === 'extend'">
                  <option value="" disabled>SÃ©lectionner un client</option>
              ...
              <div>
                ...
                <select v-model="grantForm.planId" class="input w-full" :disabled="grantMode === 'extend'">
                  <option value="" disabled>SÃ©lectionner une formule</option>
              ...
              <div>
                ...
                <input v-model="grantForm.note" type="text" class="input w-full" placeholder="Raison de l'attributionâ€¦" maxlength="500" />
              </div>
            </div>
            ...
            <div class="flex gap-3 justify-end mt-6">
              ...
              >
                {{ granting ? 'En coursâ€¦' : grantMode === 'extend' ? 'Prolonger' : 'Attribuer' }}
              </button>
            </div>
          </div>
        </div>
...
<script setup lang="ts">
  ...
  // â”€â”€ Grant modal â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  async function grantSubscription() {
    ...
    try {
      ...
      showToast(res.extended ? 'Abonnement prolongÃ© avec succÃ¨s.' : 'Abonnement attribuÃ© avec succÃ¨s.', 'success')
  ...
  async function toggleStatus(sub: Subscription, newStatus: 'ACTIVE' | 'CANCELLED') {
    ...
    try {
      ...
      showToast(
        newStatus === 'ACTIVE' ? 'Abonnement rÃ©activÃ© avec succÃ¨s.' : 'Abonnement dÃ©sactivÃ©.',
        'success'
      )
      await refresh()
    } catch (e) {
      const err = e as { data?: { statusMessage?: string }; statusMessage?: string }
      showToast(err?.data?.statusMessage ?? 'Erreur lors de la mise Ã  jour.', 'error')
    } finally {
      toggling.value = null
    }
  }
  ...
  function statusLabel(s: string) {
    const map: Record<string, string> = { ACTIVE: 'Actif', EXPIRED: 'ExpirÃ©', CANCELLED: 'AnnulÃ©', PENDING: 'En attente' }
    return map[s] ?? s
  }
