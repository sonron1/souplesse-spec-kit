...
const startCheckout = async () => {
  ...
  try {
    ...
    const { data, error } = await useFetch('/api/payments/kkiapay.create-order', {
      method: 'POST',
    ...
    const kkiapayToken = (data.value as any)?.body?.kkiapayToken || (data.value as any)?.kkiapayToken
