...
async function main() {
  ...
  const clientRows = [
    ...
    { email: 'koffi.mensah@souplesse.com',    name: 'Koffi Mensah',      firstName: 'Koffi',    lastName: 'Mensah',     phone: '+22996100002', gender: 'MALE',   birthDay: 17, birthMonth: 8,  coach: c1, subPlan: 'Abonnement 1 mois', daysLeft: 22  },
    ...
    { email: 'blessing.okonkwo@souplesse.com',name: 'Blessing Okonkwo',  firstName: 'Blessing', lastName: 'Okonkwo',    phone: '+22996100007', gender: 'FEMALE', birthDay: 11, birthMonth: 10, coach: c3, subPlan: 'Abonnement 3 mois', daysLeft: 55  },
